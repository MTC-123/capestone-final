...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        "elev-1": "0 1px 2px hsl(var(--shadow-color) / 0.05), 0 2px 8px hsl(var(--shadow-color) / 0.05)",
        "elev-2": "0 2px 4px hsl(var(--shadow-color) / 0.06), 0 10px 28px hsl(var(--shadow-color) / 0.10)",
        "elev-3": "0 4px 10px hsl(var(--shadow-color) / 0.08), 0 24px 56px hsl(var(--shadow-color) / 0.18)",
        glass: "0 4px 30px hsl(0 0% 0% / 0.08), 0 1px 3px hsl(0 0% 0% / 0.04)",
        "inner-soft": "inset 0 1px 2px hsl(220 40% 2% / 0.06)",
        "glow-green": "0 0 24px hsl(var(--primary) / 0.28)",
        "glow-red": "0 0 24px hsl(var(--danger) / 0.30)",
        "glow-fire": "0 0 28px hsl(var(--accent-fire) / 0.35)",
      },
    },
  },
  plugins: [],
