    ...
    <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4 space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-surface-2 rounded-xl p-2.5">
          ...
          <div className="font-mono text-lg font-semibold tabular">{totalCapacity}</div>
        </div>
        ...
        {selectedTeams.length > 0 && (
          <div className="bg-surface-2 rounded-xl p-2.5">
            ...
            <div className="font-mono text-lg font-semibold tabular">{selectedTeams.length}/5</div>
          </div>
        )}
        ...
        {selectedVehicles.length > 0 && (
          <div className="bg-surface-2 rounded-xl p-2.5">
            ...
            <div className="font-mono text-lg font-semibold tabular">{selectedVehicles.length}/5</div>
          </div>
        )}
        ...
        {selectedVehicles.length > 0 && (
          <div className="bg-surface-2 rounded-xl p-2.5">
            ...
            <div className="font-mono text-lg font-semibold tabular">{totalVehicleCapacity.toLocaleString()} L</div>
          </div>
        )}
