    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === 'fire' && 'bg-accent-fire text-on-accent-fire shadow-glow-fire hover:brightness-110',
          variant === 'danger' && 'bg-danger text-on-danger shadow-elev-1 hover:brightness-110',
