...
export const RATE_LIMITS = {
  ...
  guestSession: { limit: 20, windowSeconds: 600 },
  guestReport: { limit: 5, windowSeconds: 600 },
  guestReceipt: { limit: 30, windowSeconds: 600 },
  guestUpload: { limit: 10, windowSeconds: 600 },
